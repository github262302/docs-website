...
`dosfstools ntfs-3g exfat-utils f2fs-tools udftools xfsprogs`补全gparted的功能
...
```
sudo pacman -S --needed mission-center firefox ark gwenview kcalc kate pacman-contrib partitionmanager dosfstools ntfs-3g exfat-utils f2fs-tools udftools xfsprogs filelight haruna ksystemlog easyeffects
```
...
`dosfstools ntfs-3g exfat-utils f2fs-tools udftools xfsprogs`是对gparted功能的补全
