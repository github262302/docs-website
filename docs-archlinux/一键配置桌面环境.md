...
- 空载cpu和内存占用
    ...
    测试平台：机械革命无界14X 8745HS 24GB  

    |                          | CPU占用 | 相对内存占用 | 内存占用（MB） |
    | ------------------------ | ------- | ------------ | -------------- |
    | 无桌面（仅TTY）          | 0%      | 100%         | 800            |
    | Shorin's Niri            | 0%      | 160%         | 1280           |
    | DMS Niri                 | 0%      | 172%         | 1372           |
    | DMS Hyprland             | 0%      | 192%         | 1536           |
    | GNOME                    | 0%      | 224%         | 1792           |
    | Caelestia                | 1%      | 242%         | 1935           |
    | End4 (illogical Impulse) | 0%      | 243%         | 1946           |
    | KDE Plasma               | 0%      | 268%         | 2140           |
    | Win10                    | 1~14%   | 640%         | 5120           |
    | Win11                    | 1~14%   | 704%         | 5632           |
...
- 如果安装完成后打开桌面卡死请检查你的显卡驱动，虚拟机检查3D加速又没有开
